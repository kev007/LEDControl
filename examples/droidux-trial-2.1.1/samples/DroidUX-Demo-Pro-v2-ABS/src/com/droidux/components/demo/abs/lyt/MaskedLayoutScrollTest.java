...
public class MaskedLayoutScrollTest extends BaseTestActivity {
	@Override
	protected int getLayoutId() {
		return R.layout.activity_maskedlayoutscrolltest;
	}

    @Override
    protected int getDescriptionRes() {
        return R.string.activity_lyt_masked_scroll_desc;
    }
