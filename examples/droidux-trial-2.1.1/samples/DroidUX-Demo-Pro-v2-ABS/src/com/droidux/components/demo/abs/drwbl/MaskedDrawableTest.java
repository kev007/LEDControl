...
public class MaskedDrawableTest extends BaseTestActivity {
    public void onCreate(Bundle savedInstanceState) {
        ...
        iv.setImageDrawable(new MaskedDrawable(getResources().getDrawable(R.drawable.happy_girl), new ShapeDrawable(new OvalShape())));
    ...
    protected int getDescriptionRes() {
        return R.string.activity_drwbl_masked_desc;
    }
}