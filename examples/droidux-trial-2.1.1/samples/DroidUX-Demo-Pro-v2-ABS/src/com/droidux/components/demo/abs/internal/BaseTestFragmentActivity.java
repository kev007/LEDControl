 ...
 *
 */
public abstract class BaseTestFragmentActivity extends SherlockFragmentActivity {
        ...
        if (descriptionRes != 0) {
            ...
            help.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mTooltip = ActivityHelper.setupDescriptionTooltip(BaseTestFragmentActivity.this, mTooltip, descriptionRes);
                    mTooltip.show(v);
                }
            });
        }
