...
public abstract class BaseTestActivity extends SherlockActivity {
        ...
        if (descriptionRes != 0) {
            ...
            help.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mTooltip = ActivityHelper.setupDescriptionTooltip(BaseTestActivity.this, mTooltip, descriptionRes);
                    mTooltip.show(v);
                }
            });
        }
