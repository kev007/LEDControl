...
public class RoundedCornerLongTest extends BaseTestActivity {

	int mCount = 10;
	@Override
	protected int getLayoutId() {
		return R.layout.activity_roundedcornerlongtest;
	}

    @Override
    protected int getDescriptionRes() {
        return R.string.activity_lyt_rounded_long1_desc;
    }
