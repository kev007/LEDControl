 ...
 *
 */
public class ActionDrawerPositionLeftTest extends ActionDrawerModeWindowTest implements ActionDrawer.Callback {
    @Override
    void buildDrawer() {
    ...
    protected int getDescriptionRes() {
        return R.string.activity_actn_drawer_left_desc;
    }
}