...
public class RoundedCornerLong2Test extends BaseTestActivity {

	@Override
	protected int getLayoutId() {
		return R.layout.activity_roundedcornerlong2test;
	}

    @Override
    protected int getDescriptionRes() {
        return R.string.activity_lyt_rounded_long2_desc;
    }
