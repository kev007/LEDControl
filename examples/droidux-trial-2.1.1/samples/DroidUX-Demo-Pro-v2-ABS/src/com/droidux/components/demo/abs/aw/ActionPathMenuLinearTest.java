 ...
 *
 */
public class ActionPathMenuLinearTest extends BaseTestActivity implements ActionItem.OnActionListener {
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        ActionPathMenu pathMenu = (ActionPathMenu) findViewById(R.id.pathMenu);
        pathMenu.beginLinearLayout(R.layout.actionpath_control, R.id.controlIndicator)
                ...
                .setLineParams(getResources().getConfiguration().orientation==Configuration.ORIENTATION_PORTRAIT?-90:0, 16)
                .endLayout();
    ...
    protected int getDescriptionRes() {
        return R.string.activity_actnpth_linear_desc;
    }
