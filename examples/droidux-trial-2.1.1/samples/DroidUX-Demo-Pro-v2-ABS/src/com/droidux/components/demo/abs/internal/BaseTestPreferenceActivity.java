...
public abstract class BaseTestPreferenceActivity extends SherlockPreferenceActivity {
        ...
        if (descriptionRes != 0) {
            ...
            help.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mTooltip = ActivityHelper.setupDescriptionTooltip(BaseTestPreferenceActivity.this, mTooltip, descriptionRes);
                    mTooltip.show(v);
                }
            });
        }
